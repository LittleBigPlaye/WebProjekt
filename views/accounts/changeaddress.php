...
<div class="formWrapper">
    <form method="post" class="productForm" action="?c=accounts&a=changeaddress">
        ...
        <div class="input">
            ...
            <input type="text" id="city" name="city" required value="<?= htmlspecialchars($_POST['city'] ?? $address->city) ?>">
            <span class="errorInfo">Aus welchen schönen Ort kommen Sie denn?</span>
        </div>

        <div class="input">
            <label class="required" for="zipCode">Postleitzahl</label>
            <input type="text" id="zipCode" name="zipCode" required value="<?= htmlspecialchars($address->zipCode) ?>">
