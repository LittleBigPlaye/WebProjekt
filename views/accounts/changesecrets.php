...
<div class="formWrapper">
    <form method="post" class="productForm" action="?c=accounts&a=changesecrets">
        ...
        <div class="input">
            ...
            <input class="input_register1" id="password" name="password" type="password" placeholder="Neues Passwort">
        ...
        <div class="input">
            ...
            <input class="input_register1" id="password2" name="password2" type="password" placeholder="Neues Passwort wiederholen">
